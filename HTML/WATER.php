...
<section class="home container" id="home">
    <img src="https://images.alphacoders.com/101/1010655.jpg" alt="">
    <div class="text">
        <h1>One Piece<br><span>WATER SEVEN</span></h1>
    </div>
    <div class="btn">
...
<video id="video" controls poster="https://cdna.artstation.com/p/assets/covers/images/001/290/302/large/kimberly-schoenmakers-onepiecealabasta.jpg?1443721941 ">
    ...
    <?php
if (isset($_GET['ep'])) {
    echo 'https://16.mugiwara.xyz/op/saga-4/hd/' . $_GET['ep'] . '.mp4'; 
} else {
    echo 'https://16.mugiwara.xyz/op/saga-4/hd/207.mp4';
}
?> 
    >
 ...
 <h5>Saga 4:Water Seven(207-325) </h5>
...
echo '<ul>';
while ($i<326) {
    echo '<li><a href="../HTML/WATER.php?ep=' . $i . '" id="ep' . $i . '">Episode ' . $i . '</a></li>';
    $i = $i + 1;
}
echo '</ul>';
?>
