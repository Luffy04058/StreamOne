...
<!-- style.css -->
<link rel="stylesheet" href="SKYPIA.css">
...
<section class="home container" id="home">
    <img src="https://wallpapercave.com/wp/wp2551923.jpg" alt="">
    <div class="text">
        <h1>One Piece<br><span>SKYPIA</span></h1>
    </div>
    <div class="btn">
...
<video id="video" controls poster="https://i.ytimg.com/vi/roh9-UUz-xs/maxresdefault.jpg ">
    <source src=  
    <?php
if (isset($_GET['ep'])) {
    echo 'https://16.mugiwara.xyz/op/saga-3/hd/op-' . $_GET['ep'] . '.mp4'; 
} else {
    echo 'https://16.mugiwara.xyz/op/saga-3/hd/op-136.mp4';
}
?> 
    >
...
echo '<ul>';
while ($i<207) {
    echo '<li><a href="../HTML/SKYPIA.php?ep=' . $i . '" id="ep' . $i . '">Episode ' . $i . '</a></li>';
    $i = $i + 1;
}
echo '</ul>';
?>
